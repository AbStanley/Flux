/**
 * Converts a HEX color string to Tailwind-compatible HSL format.
 * Format: "H S% L%" (Space separated, no commas, no 'hsl()')
...
/**
 * Converts Tailwind-compatible HSL to HEX.
 * Input: "H S% L%" or "H S L"
